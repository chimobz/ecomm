...
//extends ProductRepository with FavoritesRepository 
{
...
*/
  ...
  @override
  Future addToFavorites(Product product, ) async {
    dataStorage.favProducts.add(FavoriteProduct(product));
    //, selectedAttributes));
  }
  ...
  Future<List<FavoriteProduct>> getFavoriteProducts(
    //{int pageIndex = 0, int pageSize = AppConsts.page_size, 
     // SortRules sortRules = const SortRules(), FilterRules filterRules}
      ) async {
