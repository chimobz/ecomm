...
import 'package:shop_app/components/bottom_menu.dart';
...
class CustomScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: title != null
          ? AppBar(title: Text(title,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 19,color: Colors.black),), bottom: tabWidget, actions: <Widget>[
              Row(children: <Widget>[
              //  Icon(Icons.share),
              ])
            ])
